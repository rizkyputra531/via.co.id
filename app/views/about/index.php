<header class="page-header page-header-dark bg-img-cover overlay overlay-80"
    style='background-image: url("<?= BASEURL; ?>/img/header3.jpg")'>
    <div class="page-header-content py-10">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="page-header-title mb-3">Tentang Perusahaan Kami</h1>
                    <p class="page-header-text">Budaya perusahaan kami, dan cara kami melakukan sesuatu</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <hr class="my-5" />
                <h4>Feedback</h4>
                <p class="lead">In the spirit of thinking rigorously, we’d love your open and honest feedback on this
                    guide. <a href="#!">Let us know what you think</a>.</p>
