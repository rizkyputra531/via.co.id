<div id="layoutDefault_footer">
    <footer class="footer pt-10 pb-5 mt-auto bg-black footer-dark">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-brand">PT. Via Digital Indonesia</div>
                    <div class="mb-3">Via Development</div>
                    <div class="icon-list-social mb-5">
                        <a class="icon-list-social-link" href="javascript:void(0);"><i
                            ...
                            class="icon-list-social-link" href="javascript:void(0);"><i class="fab fa-github"></i></a><a
                            class="icon-list-social-link" href="javascript:void(0);"><i class="fab fa-twitter"></i></a>
                    </div>
                </div>
                <!--
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-2"><a href="<?= BASEURL; ?>/it_solution">IT Solution</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 small">Copyright &copy; via digital indoenesia 2020</div>
...
<script src="<?= BASEURL; ?>/js/scripts_count.js"></script>
<script src="<?= BASEURL; ?>/js/lity.min.js"></script>
