<header class="page-header page-header-dark bg-img-cover overlay overlay-80"
    style="background-image: url(<?= BASEURL; ?>/img/header5.jpg);">
    <div class="page-header-content py-10">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="page-header-title mb-3">Publikasi</h1>
                    <p class="page-header-text mb-0">Jelajahi artikel, ikuti perkembangan terbaru, dan pelajari lebih
                        lanjut di blog kami!</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
            ...
            <div class="row no-gutters">
                <div class="col-lg-5">
                    <div class="post-preview-featured-img"
                        style='background-image: url("https://source.unsplash.com/vZJdYl5JVXY/660x360")'></div>
                </div>
                <div class="col-lg-7">
                    <div class="card-body">
                        <div class="py-5">
        ...
        <div class="row">
            <div class="col-md-6 col-xl-4 mb-5">
                <a class="card post-preview lift h-100" href="#!"><img class="card-img-top"
                        src="https://source.unsplash.com/KE0nC8-58MQ/660x360" alt="..." />
                    <div class="card-body">
            ...
            <div class="col-md-6 col-xl-4 mb-5">
                <a class="card post-preview lift h-100" href="#!"><img class="card-img-top"
                        src="https://source.unsplash.com/hGV2TfOh0ns/660x360" alt="..." />
                    <div class="card-body">
            ...
            <div class="col-md-6 col-xl-4 mb-5">
                <a class="card post-preview lift h-100" href="#!"><img class="card-img-top"
                        src="https://source.unsplash.com/9l_326FISzk/660x360" alt="..." />
                    <div class="card-body">
            ...
            <div class="col-md-6 col-xl-4 mb-5">
                <a class="card post-preview lift h-100" href="#!"><img class="card-img-top"
                        src="https://source.unsplash.com/oqStl2L5oxI/660x360" alt="..." />
                    <div class="card-body">
            ...
            <div class="col-md-6 col-xl-4 mb-5">
                <a class="card post-preview lift h-100" href="#!"><img class="card-img-top"
                        src="https://source.unsplash.com/Oalh2MojUuk/660x360" alt="..." />
                    <div class="card-body">
            ...
            <div class="col-md-6 col-xl-4 mb-5">
                <a class="card post-preview lift h-100" href="#!"><img class="card-img-top"
                        src="https://source.unsplash.com/-uHVRvDr7pg/660x360" alt="..." />
                    <div class="card-body">
